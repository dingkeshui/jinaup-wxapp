<template>
  <div class="wrap">
    ...
    <div class="backtostore flex">
      <div class="flex1 center" @click="goHome">
...
export default {
  ...
  onLoad(options) {
    ...
    that.createTime = options.createTime;
      ...
      if (result.data.res_code == 1) {
        wx.requestPayment({
          ...
          success: res => {
            ...
            wx.redirectTo({
              url:
                "/pages/myorder/cashDetails/main?price=" + that.price + "&number=" + that.orderId + "&isok=" + 1
            })
          },
          fail: () => {
            console.log("支付失败")
            wx.redirectTo({
              url:
                "/pages/myorder/cashDetails/main?price=" + that.price + "&number=" + that.orderId + "&isok=" + 2
            })
          },
        })
      } else {
