...
const actions={
    async getDatail({commit},payload){
        ...
        // if (result.data.result.totalDiscountAmount) {
        //     result.data.result.payAllMoney = (result.data.result.totalAmount-result.data.result.totalDiscountAmount).toFixed(2)
        // } else {
        //     result.data.result.payAllMoney = result.data.result.totalAmount
        // }
